    ...
    <header className="navbar fixed-top">
      <div className="container">
        ...
        <ul className="navbar-nav">
          <li>
            <a href="https://github.com/loco-rs/loco?ref=starter" target="_blank" rel="noopener noreferrer">
          ...
          <li>
            <a href="https://github.com/loco-rs/loco/stargazers?ref=starter" target="_blank" rel="noopener noreferrer">
